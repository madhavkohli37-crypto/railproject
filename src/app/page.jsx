      ...
      <section className="relative bg-gradient-to-br from-[#0f2347] via-[#1a3a6b] to-[#1e4d8c] text-white py-24 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {user ? (
              <>
                <Link href="/book" className="bg-orange-500 hover:bg-orange-600 text-white font-bold px-8 py-4 rounded-xl text-lg transition-all shadow-lg hover:shadow-orange-500/40">
                  🧳 Book Assistance
                </Link>
                <Link href="/dashboard" className="bg-white/10 hover:bg-white/20 border border-white/30 text-white font-bold px-8 py-4 rounded-xl text-lg transition-all">
                  📊 My Dashboard
                </Link>
              </>
            ) : (
              <>
                <Link href="/signup" className="bg-orange-500 hover:bg-orange-600 text-white font-bold px-8 py-4 rounded-xl text-lg transition-all shadow-lg hover:shadow-orange-500/40">
                  Get Started Free
                </Link>
                <Link href="/login" className="bg-white/10 hover:bg-white/20 border border-white/30 text-white font-bold px-8 py-4 rounded-xl text-lg transition-all">
                  Sign In
                </Link>
              </>
            )}
